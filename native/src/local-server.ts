 ...
 *  the first one is what keeps the user's reports across launches.
 *
...
const PORT_LADDER = [8291, 8292, 8293] as const;
...
export type LocalServer = {
  /** The origin to point the WebView at, e.g. `http://localhost:8291`. */
  origin: string;
  stop: () => Promise<void>;
};
