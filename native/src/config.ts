...
// cycle log works with no network and changes only when a new build ships to
...
// latter.
//
// `EXPO_PUBLIC_CYCLE_URL` overrides that at build time, pointing the WebView at
 ...
 *  the bundle locally. */
export const REMOTE_URL: string | undefined = process.env.EXPO_PUBLIC_CYCLE_URL;
