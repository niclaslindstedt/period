...
| **Calendar** | A month at a time. Periods and fertile windows are drawn as one stroke across the days they cover — filled where you reported bleeding, outlined where a period is expected. It projects past the next period too, as far ahead as your history can place one. Pages either way. |
