...
//! wrong to simplify.
//!
//! The site is served from a registered private scheme (`cycle://`, see
...
//!     settings in `localStorage`, both keyed by origin. `cycle://` is a
...
/// `cycle:///C:/…` must not become a drive letter.
