...
//! shipping: `CYCLE_APP_URL` points the window at a remote URL instead (the
//! `/preview/` deploy slot, say), and `CYCLE_WEBROOT` serves a different
...
/// install.
pub const APP_SCHEME: &str = "cycle";
...
pub const WINDOW_TITLE: &str = "Cycle";
